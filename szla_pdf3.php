...
$query = "SELECT * FROM szla_fej where user_id=$user_id and szla_sorszam='$szla_sorszam'"; 
$result = mysqli_query($con, $query);
...
$result_tetel = mysqli_query($con, $query_tetel);
			...
			// oszerakjuk a cimet
				...
				if ($felhasznalo_epulet != "") { $felhasznalo_epulet = $felhasznalo_epulet.". Épület"; }
				...
				if ($felhasznalo_ajto != "") { $felhasznalo_ajto = $felhasznalo_ajto.". Ajtó";}
...
// innen kezdÅ‘dik a tartalmi rÃ©sz
