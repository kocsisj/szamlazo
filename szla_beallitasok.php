...
$query = "SELECT * from szla_beallitasok where user_id='".$id."'"; 
$result = mysqli_query($con, $query) or die ( mysql_error());
...
$update="update szla_beallitasok set szla_elotag='$szla_elotag', szla_megjegyzes='$szla_megjegyzes', szla_feliratok='$szla_feliratok', szla_penzforgelsz='$szla_penzforgelsz', szla_onszamla='$szla_onszamla', szla_ford_ado='$szla_ford_ado', szla_adoment_hiv='$szla_adoment_hiv' where user_id=$id";
$insert="INSERT INTO szla_beallitasok (user_id, szla_elotag, szla_megjegyzes, szla_feliratok, szla_penzforgelsz, szla_onszamla, szla_ford_ado, szla_adoment_hiv ) VALUES ('$id', '$szla_elotag', '$szla_megjegyzes', '$szla_feliratok', '$szla_penzforgelsz', '$szla_onszamla', '$szla_ford_ado', '$szla_adoment_hiv')";
...
<input type="hidden" name="new" value="1" />
 <tr>
  <td width = "200">Számla sorszám előtag:</td>
<td><input type="text" name="szla_elotag" placeholder="Számlaszám előtag" required value="<?php echo $row['szla_elotag'];?>" size="10" />/számlaszám</td>
...
<tr>
   <td></td>   <td><b><br>Ide irhat olyan szöveget ami minden számlán meg fog jelenni.</b></td>
